...
| repositório associado (V2-T27, D-027/D-028) | `AssociatedRepository` (`core/types.ts`, `{ name, remote }`) — um repositório de código da pessoa que um projeto aponta para; só leitura, o `seeya` nunca escreve nele. Vazio em todo projeto criado pela V2-T27 (`add-repo` é V2-T28) |
...
`project` (`create` / `list` / `show`, V2-T27), e `--session`, `--all`, `--stop`, `--dry-run`. Os três
