...
pronta numa worktree isolada**, portão local verde no Windows, dois artefatos Linux construídos e
...
mesclagem, rodar `verificar:linux` de verdade, o workflow manual, e o aceite do mantenedor (instalar
de verdade no Linux e no Windows dele, abrir pelo menu, subir o daemon pela janela, clicar num
aviso prévio). Ver `docs/QUESTOES.md` Q-078 para os números medidos e o que ficou pendente.
